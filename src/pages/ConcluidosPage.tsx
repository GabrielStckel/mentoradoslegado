          ...
          {concluidos.map(m => (
            <div key={m.id} className="rounded-xl border bg-card p-4 space-y-3">
              ...
              <div className="flex items-center gap-1 justify-end">
                <Button size="icon" variant="ghost" className="h-9 w-9" title="Ver detalhes" onClick={() => navigate(`/mentorados/${m.id}`)}>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-secondary/30 hover:bg-secondary/30">
                ...
                <TableHead className="table-header w-[140px]">Ações</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {concluidos.map(m => (
                <TableRow key={m.id} className="hover:bg-secondary/20">
                  ...
                  <TableCell>
                    <div className="flex gap-1">
                      <Button size="icon" variant="ghost" className="h-8 w-8" title="Ver detalhes" onClick={() => navigate(`/mentorados/${m.id}`)}>
                        <Eye className="h-4 w-4" />
                      </Button>
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
